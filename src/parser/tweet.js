...
class Tweet {
// Number of Tweet created with that we can easily count the number on tweet created by our class Tweet.
...
constructor(tweetDataInLine) {
        ...
        this.user_name = tweetDataInLine[28];
         // this.user_screen_name once agian .. error in CSV data ..
...
/* One more Tweet 
   if (this.nombreDeTweet == undefined){
    this.nombreDeTweet = 0;
